...
export default function App() {
  ...
  const s = {
    app: { minHeight:"100vh", background:"linear-gradient(135deg,#0a0a0f 0%,#0d0d1a 50%,#0a0a0f 100%)", fontFamily:"'Space Grotesk',Arial,sans-serif", color:"white", display:"flex", flexDirection:"column", alignItems:"center", padding:"20px 16px 40px" },
    card: { background:"linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))", border:"1px solid rgba(255,255,255,0.08)", borderRadius:"24px", padding:"28px 24px", width:"100%", maxWidth:"420px", boxSizing:"border-box" },
  ...
  return (
    <div style={s.app}>
      ...
      {/* Nav */}
      <div style={{width:"100%", maxWidth:"420px", paddingTop:"12px", marginBottom:"20px"}}>
        {/* Logo + badge PRO */}
        ...
        {/* Tabs */}
        <div style={{display:"flex", gap:"6px", background:"rgba(255,255,255,0.03)", borderRadius:"14px", padding:"4px"}}>
      ...
      {view === "home" && step === "upload" && (
        <div style={{textAlign:"center", marginBottom:"20px"}}>
          <h1 style={{fontSize:"26px", fontWeight:"800", letterSpacing:"-1px", margin:"0 0 6px", background:"linear-gradient(135deg,#fff,#aaa)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent"}}>Connaît ton vrai physique</h1>
