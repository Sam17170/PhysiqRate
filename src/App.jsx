...
export default function App() {
  ...
  return (
    <div style={s.app}>
          ...
          <div style={{display:"flex", flexDirection: isMobile ? "column" : "row", gap:"20px", alignItems:"stretch"}}>
            ...
            {!isMobile && (
              <div style={{flex:1}}>
                <div style={{...s.card, height:"100%"}}>
                  <div style={{fontSize:"11px", color:"#FFD700", letterSpacing:"2px", marginBottom:"20px"}}>POURQUOI PHYSIQRATE ?</div>
                  {[
                    ["🎯", "Précision IA", "Analyse visuelle calibrée sur des milliers de physiques"],
                    ["⚡", "Résultat immédiat", "Ton body fat et ton archétype en moins de 10 secondes"],
                    ["📈", "Suivi dans le temps", "Suis ta progression semaine après semaine"],
                    ["🔒", "100% privé", "Tes photos ne sont jamais stockées sur nos serveurs"],
                  ].map(([icon, title, desc], i) => (
                    <div key={i} style={{display:"flex", gap:"14px", marginBottom:"20px", alignItems:"flex-start"}}>
                      <div style={{fontSize:"22px", minWidth:"32px"}}>{icon}</div>
                      <div>
            ...
            <div style={{flex:1, display:"flex", flexDirection:"column", gap:"16px"}}>
              <div style={s.card}>
                ...
                <div style={{marginTop:"16px", padding:"14px", background:"rgba(255,215,0,0.04)", borderRadius:"12px", border:"1px solid rgba(255,215,0,0.1)"}}>
      ...
      {/* DASHBOARD */}
      {view === "dashboard" && (
        <div style={{width:"100%", maxWidth: isMobile ? "420px" : "900px", display:"flex", flexDirection:"column", gap:"16px", alignItems:"center"}}>
          {!premium ? (
            <div style={{...s.card, textAlign:"center"}}>
              <div style={{fontSize:"40px", marginBottom:"16px"}}>📈</div>
